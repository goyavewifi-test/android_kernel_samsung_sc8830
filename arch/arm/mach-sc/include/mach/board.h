...
#ifdef	CONFIG_MACH_SP7730EEA_FPGA
#include "__board-sp7730eea_fpga.h"
#endif
...
#ifdef	CONFIG_MACH_SP8730SEEA_JIGBOARD
#include "__board-sp8730seea_jigboard.h"
#endif
...
#ifdef  CONFIG_MACH_TSHARK2GOYAL
...
#ifdef  CONFIG_MACH_GTELWIFI
#include "__board-gtelwifi.h"
#endif
...
#endif
#else
#if (defined(CONFIG_MACH_SP8730SEEA)  || defined(CONFIG_MACH_SP8730SEEA_QHD) || defined(CONFIG_MACH_TSHARK2GOYAL))
#define SPRD_ION_MEM_BASE	\
